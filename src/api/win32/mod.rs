...
fn get_nid_struct(hwnd: &HWND) -> shellapi::NOTIFYICONDATAW {
    shellapi::NOTIFYICONDATAW {
        cbSize: std::mem::size_of::<shellapi::NOTIFYICONDATAW>() as DWORD,
        hWnd: *hwnd,
        u: shellapi::NOTIFYICONDATAW_u::default(),
        uID: 0x1 as UINT,
        uFlags: 0 as UINT,
...
fn get_menu_item_struct() -> winuser::MENUITEMINFOW {
    winuser::MENUITEMINFOW {
        cbSize: std::mem::size_of::<winuser::MENUITEMINFOW>() as UINT,
        fMask: 0 as UINT,
        fType: 0 as UINT,
        fState: 0 as UINT,
        wID: 0 as UINT,
...
unsafe fn init_window() -> Result<WindowInfo, SystrayError> {
    ...
    let wnd = winuser::WNDCLASSW {
        ...
        lpszMenuName: 0 as ntdef::LPCWSTR,
    ...
    let m = winuser::MENUINFO {
        cbSize: std::mem::size_of::<winuser::MENUINFO>() as DWORD,
    ...
    if winuser::SetMenuInfo(hmenu, &m as *const winuser::MENUINFO) == 0 {
    ...
    pub fn add_menu_entry(&self, item_idx: u32, item_name: &String) -> Result<(), SystrayError> {
        ...
        unsafe {
            if winuser::InsertMenuItemW(
                ...
                item_idx,
                1,
                &item as *const winuser::MENUITEMINFOW,
            ) == 0
            {
